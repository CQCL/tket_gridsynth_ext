...
If you find any errors or omissions in this document, please [open an issue](https://github.com/CQCL/tket_gridsynth_ext/issues/new)!
...
PR](https://github.com/CQCL/tket_gridsynth_ext/pulls?q=is%3Aopen+is%3Apr+label%3Arelease) on
github.
...
[codecov](https://app.codecov.io/gh/CQCL/tket_gridsynth_ext/commits?branch=All%20branches).
...
We welcome contributions to the TKET extension! Please open [an issue](https://github.com/CQCL/tket_gridsynth_ext/issues/new) or [pull request](https://github.com/CQCL/tket_gridsynth_ext/compare) if you have any questions or suggestions.
...
Just create a [github release](https://github.com/CQCL/tket_gridsynth_ext/releases/new) from the **unmerged** branch.
